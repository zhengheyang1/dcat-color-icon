...
namespace Zhy\ColorfulIcon\Http\Controllers;
...
class ColorfulIconController extends AdminController
{
        ...
        return $content
            ...
            ->body(function (Row $row) {
                ...
                $row->column(5, function (Column $column) {
                    ...
                    $form->colorIcon('icon', trans('admin.icon'))->help($this->iconHelp());
    ...
    protected function treeView()
    {
        ...
        return new Tree(new $menuModel(), function (Tree $tree) {
            ...
            $tree->branch(function ($branch) {
                ...
                if (stripos($branch['icon'],'#') !== false){
                    $payload = "<svg class='icon svg-icon' aria-hidden='true'><use xlink:href='{$branch['icon']}'></use></svg>&nbsp;<strong>{$branch['title']}</strong>";
                }
